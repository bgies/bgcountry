...
<div class="bgc-row">
     <div class="form-group col-sm-12 bgc-text-right">
         ...
         <div class="col-sm-8">
            <select name="country_code" data-url="{!! route('bgcountry.default') !!}" class="form-control input-sm bgc-country-sel">
               {!! $countrycodes !!}
            </select>
     ...
     <div class="form-group col-sm-12 ">
        ...
        <div class="col-sm-8">
           <select name="province_code" data-url="{!! route('bgprovince.default') !!}" class="form-control input-sm bgc-province-sel">
               {!! $provincecodes !!}
           </select>
     ...
     <div class="form-group  col-sm-12">
        ...
        <div class="col-sm-8">
           <select name="city" class="form-control input-sm bgc-city-sel" data-url="{!! route('bgcity.default') !!}">
               {!! $citycodes !!}
           </select>
